<?php
  ...
  */
  ...
  class ChestShop implements Plugin
  {
    ...
    {
      $this->api->addHandler("tile.update", array($this, "update_eventHandler"));
      $this->api->addHandler("player.block.touch", array($this, "touch_eventHandler"));
      $this->path = $this->api->plugin->createConfig($this, array());
    }

    public function update_eventHandler($data, $event)
    {
    ...
    public function touch_eventHandler($data, $event)
    {
